...
public abstract class SetTest {
    ...
    public void removeElementsInSetDecrementsSize() {
        // Arrange
        int originalSize = uniqueSetElements.length;
        int setsRemoved = 0;
        for (int elem : uniqueSetElements) {
            // Act
            set.remove(elem);
        ...
        // Assert
        assertThat(set.size(), equalTo(originalSize-setsRemoved));
        //fail("Not implemented");
    }
    ...
    public void removeElementsDoesNotDecrementSizeWhenSetIsEmpty() {
        ...
        int sizeWhenEmpty = set.size();
        for (int elem : elementsNotInSet) {
            // Act
            set.remove(elem);
            // Assert
            assertThat(set.size(), equalTo(sizeWhenEmpty));
        }
        //fail("Not implemented");
    }
    ...
    public void removeIsFalseWhenElementIsNotInSet() {
        ...
        for (int elem : elementsNotInSet) {
            // Act
            boolean elementInSet = set.remove(elem);
            // Assert
            assertThat(elementInSet, equalTo(false));
        }
        //fail("Not implemented");
    }
